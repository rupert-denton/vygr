# Generated by Django 4.0.1 on 2022-03-19 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cafe_image_url', models.CharField(max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='UserList',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='testingland.userlist')),
            ],
        ),
        migrations.CreateModel(
            name='SharedLink',
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('cafe', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='testingland.mapcafes')),
            ],
        ),
        migrations.CreateModel(
            name='ReplyComments',
