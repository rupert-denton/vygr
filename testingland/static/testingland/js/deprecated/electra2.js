  ...
  $.ajax({
    ...
    success: function(data) {
        data.forEach((item, i) => { //what does the i refer to
            $("#list-choices").append(`<option value="${item.id}">${item.list_name}</option>`) //adds to list-choices id in
        });
	    }
	  })
	  ...
	  // Get user location
	    $("#cafes").text(function(){
	      if(navigator.geolocation) {
	        //check if geolocation functionality
					//exists (eg in browser)
	          console.log("Success")
	             ...
	             console.log("User location is " + loc);
	               ...
	               window.initMap = function() {
	                 ...
	                 console.log("Map done. User loc is " + userloc)
									 	...
									 	//if necessary, this code moves the map when user conducts a search
	                   const geocoder = new google.maps.Geocoder();
	                    document.getElementById("submit").addEventListener("click", () => {
	                      ...
	                      //after user has run a search this code gets geocoordinates ready
												//to pass to the ajax call below.
	                      function geocodeAddress(geocoder, resultsMap) {
	                        ...
	                        geocoder.geocode({ address: address }, (results, status) => {
	                          if (status === "OK") {
	                            ...
	                            $.ajax({
	                              type: 'GET',
	                              url: '/electra/cafe_list/', //this is where ajax reaches for the get request
								...
								//this code is for creating a list add
